<%-- 
    ...
    Created on : May 5, 2021, 7:28:40 PM
    Author     : Bryan
--%>
<%@page import="jwt.JWT"%>
    ...
    <body>
        ...
        <div class="text-center">
            ...
            <form action="ControlServlet" method="POST">
                ...
                <button class="btn btn-primary btn-lg btn-block botones-menu" type="submit" name="accion" value="importarAlumnos"><b>Importar alumnos</b></button>
            </form>       
           <!-- <form action="ControlServlet" method="POST">
                <button class="btn btn-secondary btn-lg btn-block botones-menu" type="submit" name="accion" value="importarAlumnos"><b>Importar alumnos</b></button>
            </form>      -->
            <form action="ControlServlet" method="POST">
