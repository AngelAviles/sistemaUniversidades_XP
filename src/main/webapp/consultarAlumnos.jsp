<%-- 
    ...
    Created on : May 3, 2021, 10:47:43 PM
    Author     : Bryan
--%>
<%@page import="jwt.JWT"%>
        ...
        <article>
            ...
            <div class="m-3">
                <div class=" gap-6 mx-auto">
                    <button class="btn btn-danger pull-right" style="width:250px;" onclick="location.href = 'administrarAlumnos.jsp'">Cancelar</button>
                </div>
            </div>
        </article>
